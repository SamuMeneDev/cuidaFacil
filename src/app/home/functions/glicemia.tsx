      ...
      <View className="p-3">
        ...
        <View className="gap-3">
          ...
          <InputDefault
            ...
            value={glicose}
            onChangeText={(e) => setGlicose(e)}
            placeholder="Insira sua taxa de glicose"
          />
          {/* ACTIONS */}
          ...
          {isObs && (
            <InputDefault
              value={txObs}
              onChangeText={setTxObs}
              placeholder="Observação"
            />
          )}
          {/* SALVAR */}
          <TextButton
            onPress={() => calcularGlicemia()}
            boxStyles="bg-sky-600"
            title="Calcular"
          />

          <Modal.root
            boxStyles="justify-center"
            animationType="slide"
            transparent
            visible={showModal}
          >
            ...
            <Modal.content>
              <View className="flex-row gap-2 justify-center">
                ...
                <Text className="text-stone-800 text-lg font-normal">
                  {result.status}
                </Text>
              </View>
              <View>
        ...
        <View>
          ...
          <View className="border border-stone-400 rounded-lg p-2">
            {historico.length < 1 ? (
              <Text className="self-center text-stone-600">
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    <View className="flex-row items-center gap-2 bg-stone-200 rounded-lg">
                      <View
                        className="w-[20%] rounded-md items-center justify-center"
                      ...
                      <View className="w-[80%] p-2">
                        <View className="flex-row items-center justify-start gap-6">
                          ...
                          <Text className="text-stone-700 text-xs">
                            {item.isJejum ? "Jejum" : "Pós-refeição"}
                          </Text>
                        </View>
